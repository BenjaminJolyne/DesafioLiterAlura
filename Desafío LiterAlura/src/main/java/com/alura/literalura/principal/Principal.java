...
this.repositorio=reposity;
    ...
    private void mostrarLibrosPorIdioma() {
        ...
        try {
            ...
            System.out.println("Idioma no disponible, intente nuevamente.\n");
        }
    ...
    private void mostrarAutoresPorAnio() {
        ...
        if (autoresVivos.isEmpty()){
            System.out.println("No hay autores vivos para el año indicado.\n");
            return;
        }
    ...
    private DatosLibros buscarLibroWeb(){
        System.out.println("Ingresa el nombre del libro que desea buscar en la Web");
    ...
    private void buscarLibroWebPrincipal(){
        ...
        if(datosOpcional.isPresent()) {
            ...
            try {
                ...
                System.out.println(libro.getTitulo() + " Libro guardado con éxito.");
