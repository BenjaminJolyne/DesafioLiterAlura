Desafio de Alura Latam de crear un catálogo de libros con el cual se debe interactuar por medio de la consola de IntelliJ además de estar conectado a el Database de pgadmin 4
